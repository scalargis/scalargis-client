...
export default function Main(props) {
  ...
  const { as, config, actions, record } = props;
  ...
  if (as === 'panel') return (
    <div ref={ref} class="p-blockui-container" style={{height: 'calc(100%)'}}>
      <Panel header={header}>
        { renderContent() }
      </Panel>
      { blockedPanel && <div class="p-blockui p-component-overlay p-component-overlay-enter" style={{zIndex: 1003, height: getBlockFullHeight()}}>
