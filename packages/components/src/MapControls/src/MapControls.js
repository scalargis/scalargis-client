...
export default function MapControls({ viewer, mainMap, core, dispatch, actions, record }) {
  ...
  return (
    <div id="map-controls" className="map-controls">
      ...
      { (!!coordinates_control && !!coordinates_control.show_button) && (
        <Button
      ...
      { (!!feature_info_control && !!feature_info_control.show_button) && (
        <Button
      ...
      { (!!geo_location_control && !!geo_location_control.show_button && !!window.navigator.geolocation) && (
        <div className="map-controls-geolocation"
      ...
      { core.renderComponents({
        region: 'map_tools',
        props: { actions, viewer, dispatch, mainMap: mainMap },
        separator: " ",
        parent: record
      }) }
