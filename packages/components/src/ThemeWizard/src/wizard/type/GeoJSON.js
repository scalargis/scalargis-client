...
class GeoJSON extends Component {
   ...
   */
  loadGeoJSONFile(e) {
    const { mainMap, viewer, data, setLoading, setData, setError, Models, fastFetch } = this.props;
  ...
  loadFromUserURL() {
    let { data, setData, setSelected, setError, cookies, setLoading, Models } = this.props;
