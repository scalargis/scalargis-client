...
function PrintGroupList(props) {
  ...
  //const { backoffice_set_printsgroupsfilter } = core.actions;
...
export default connect(state => ({ loading: state.loading }))(withRouter(PrintGroupList));